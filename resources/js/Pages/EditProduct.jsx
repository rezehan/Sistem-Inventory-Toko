...
export default function CreateOrEditProduct({ auth, flash, product = null }) {
    ...
    const { data, setData, put, post, processing, errors, reset } = useForm({
        sku: product?.sku || '',          // Jika product ada, pakai sku-nya. Jika tidak, kosong.
        name: product?.name || '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (product) {
            // 3. Jika mode EDIT (ada data product), gunakan method PUT
            ...
            // 4. Jika mode CREATE (tidak ada data), gunakan method POST
